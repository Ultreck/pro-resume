...
function App() {
  ...
  const { downloadPDF, resumeContents, setIsOpen, isOpen } = UseHook();
  // console.log(tabName);
  useEffect(() => {
    Aos.init();
  }, []);
  ...
  return (
    <div className="bg-[#0a192f] w-full overflow-hidden">
      ...
      <div className="text flex">
        <div className="text md:w-24 w-16">
          <SideNav />
        </div>
        <div className="text w-11/12">
          <Routers />
        </div>
        <div className="text md:w-32 w-14">
          <TitleBar />
        </div>
        {navigation && (
          <div
      ...
      <div className="text" ref={resumeContents}>
        <Modal isOpen={isOpen} closeModal={() => setIsOpen(false)}>
          {tabName === "Contact" && (
            <div className="text w-full h-screen rela flex items-center justify-center">
              <span
                className="text-black absolute right-10 top-10 md:right-20 rounded-full  md:top-20 cursor-pointer z-50 hover:rotate-[100deg] border-2 border-red-500 duration-100 ease-in-out"
              ...
              <div
                ...
                data-aos="zoom-in-up"
                className={`inline-block align-bottom bg-[#0a192f] p-6 rounded-lg text-left overflow-hidden md:w-1/3
          ...
          {tabName === "Resume" && (
            <div className="text w-full min-h-screen flex items-center justify-center">
              <span
                className="text-black absolute md:right-20 right-8 rounded-full  md:top-20 top-8 cursor-pointer z-50 hover:rotate-[100deg] border-2 border-red-500 duration-100 ease-in-out"
                onClick={() => setIsOpen(false)}>
                <RxCross2 className="text-red-500 font-bold text-2xl" />
              </span>
              <div
                className={`inline-block align-bottom bg-[#0a192f] p-6 rounded-lg text-left overflow-hidden w-full md:w-2/3
              shadow-xl transform transition-all sm:my-20 sm:align-middle text-[#8a9fb8]`}>
                <div className="text">
                ...
                <div className="text ">
                  <div className="text">
                    ...
                    <div className="text ">
                      <img
                        src={img2}
                        alt=""
                        className="text w-40 h-40 md:w-56 md:h-56 float-right rounded-lg mx-3"
                      />
                      <p
                        ...
                        developer based in Lagos, Lagos State, Nigeria. I design
                        a well responsive, easy to use, interactive, intuitive
                        and best user experience website. I also work as a
                      ...
                      <p
                        ...
                        technologies, allowing me to create seamless and robust
                        web applications from start to finish. My experience
                        spans across various tech stacks, and I thrive on{" "}
                        <span className="">
                      ...
                      <p
                        ...
                        With a strong foundation in frontend technologies such
                        as HTML, CSS, React.js, Angular.js, Vue.js, and
                        JavaScript, coupled with expertise in backend frameworks
                        ...
                        , I'm committed to delivering excellence at every stage
                        of development.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="text-sm my-10">
                    ...
                    <div className="text grid grid-cols-2 md:grid-cols-4 gap-10 justify-between px-5">
                  ...
                  <div className="text-center my-10">
                    <button className="text-[#64ffda] bg-[#64ffda] rounded font-mono">
                      <button
                        ...
                        className="text-[#64ffda] border border-[#64ffda] hover:-translate-x-1 transition hover:-translate-y-1 bg-[#0a192f] rounded px-5 py-2 font-mono">
                        Download my Cv
                      </button>
                    </button>
                  </div>
